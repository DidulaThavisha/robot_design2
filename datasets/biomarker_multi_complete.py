...
class BiomarkerDatasetAttributes_MultiLabel_Complete(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ped_serous = self.df.iloc[idx,17]
        ...
        bio_tensor = torch.tensor([fluid_irf,drt,ir_hrf,full_vit,partial_vit,atrophy,EZ,DRIL,IR_hemm,preret_tiss,vit_deb,vmt,rpe,shrm,fluid_srf,ped_serous])
