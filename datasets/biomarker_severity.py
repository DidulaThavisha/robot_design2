...
class BiomarkerDatasetAttributes_Severity(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        gradcon_5000 = self.df.iloc[idx,28]

        return image, vit_deb,ir_hrf, full_vit,partial_vit,fluid_irf,drt,eye_id,bcva,cst,patient,gradcon_5000