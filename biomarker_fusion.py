...
import torch
import os
class BiomarkerDatasetAttributes_Fusion(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        clinical_tensor = torch.tensor([eye_id,bcva,cst,patient])
        return image, vit_deb,ir_hrf, full_vit,partial_vit,fluid_irf,drt,clinical_tensor
