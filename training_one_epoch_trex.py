...
def train_TREX(train_loader, model, criterion, optimizer, epoch, opt):
    """one epoch training"""
    model.train()
    ...
    for idx, (images, bcva,snellen,cst,eye_id,patient) in enumerate(train_loader):
        ...
        if opt.method1 == 'patient':
            ...
            labels1 = cst.cuda()
        elif opt.method1 == 'snellen':
            labels1 = snellen.cuda()
        ...
        if opt.method2 == 'patient':
            ...
            labels2 = cst.cuda()
        elif opt.method2 == 'snellen':
            labels2 = snellen.cuda()
        ...
        if opt.method3 == 'patient':
            ...
            labels3 = cst.cuda()
        elif opt.method3 == 'snellen':
            labels3 = snellen.cuda()
        ...
        if opt.method4 == 'patient':
            ...
            labels4 = cst.cuda()
        elif opt.method4 == 'snellen':
            labels4 = snellen.cuda()
        ...
        if opt.method5 == 'patient':
            ...
            labels5 = cst.cuda()
        elif opt.method5 == 'snellen':
            labels5 = snellen.cuda()
